...
print(
    find_first_occurence1([2, 5, 1, 2, 3, 5, 1, 2, 4])
    == find_first_occurence2([2, 5, 1, 2, 3, 5, 1, 2, 4])
    == find_first_occurence3([2, 5, 1, 2, 3, 5, 1, 2, 4])
)  # true
print(
    find_first_occurence1([2, 1, 1, 2, 3, 5, 1, 2, 4])
    == find_first_occurence2([2, 1, 1, 2, 3, 5, 1, 2, 4])
)  # false
...
print(
    find_first_occurence1([2, 3, 4, 5])
    == find_first_occurence2([2, 3, 4, 5])
    == find_first_occurence3([2, 3, 4, 5])
)  # true
